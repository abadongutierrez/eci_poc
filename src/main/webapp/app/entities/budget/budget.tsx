...
export type IBudgetState = IPaginationBaseState;

export class Budget extends React.Component<IBudgetProps, IBudgetState> {
  state: IBudgetState = {
    ...
    return (
      <div>
        <h2 id="budget-heading">
          <Translate contentKey="eciApp.budget.home.title">Budgets</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="eciApp.budget.home.createLabel">Create new Budget</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="eciApp.budget.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
