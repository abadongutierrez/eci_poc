    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="eciApp.skill.home.createOrEditLabel">
              <Translate contentKey="eciApp.skill.home.createOrEditLabel">Create or edit a Skill</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : skillEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="descriptionLabel" for="skill-description">
                    <Translate contentKey="eciApp.skill.description">Description</Translate>
                  </Label>
                  <AvField id="skill-description" type="text" name="description" />
                </AvGroup>
