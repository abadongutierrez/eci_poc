...
public class Client implements Serializable {
    ...
    public Client clientProjects(Set<ClientProject> clientProjects) {
        this.clientProjects = clientProjects;
        return this;
    }

    public Client addClientProject(ClientProject clientProject) {
        this.clientProjects.add(clientProject);
        clientProject.setClient(this);
        return this;
    }

    public Client removeClientProject(ClientProject clientProject) {
        this.clientProjects.remove(clientProject);
